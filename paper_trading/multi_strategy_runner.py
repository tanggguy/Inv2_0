...
class StrategyInstance:
    ...
    def initialize(self):
        ...
        try:
            ...
            logger.info(f"Stratégie {self.name} initialisée avec ${self.config['capital_allocation']:.2f}")
    ...
    def _load_strategy_class(self):
        ...
        try:
            ...
            strategy_mapping = {
                ...
                'MeanReversion': ('strategies.advanced_strategies', 'MeanReversionStrategy'),
                ...
                if hasattr(strat, 'analyzers'):
                    ...
                    if hasattr(strat.analyzers, 'trades'):
                        ...
                        if self.performance['trades'] > 0:
                            self.performance['win_rate'] = won / self.performance['trades']
