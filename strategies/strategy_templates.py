...
class MyFirstStrategy(BaseAdvancedStrategy):
    ...
    def __init__(self):
        ...
        self.my_indicator = bt.indicators.SMA(
            self.datas[0].close, period=self.params.my_parameter
        )
...
class TripleIndicatorStrategy(BaseAdvancedStrategy):
    ...
    def __init__(self):
        ...
        # Tendance
        self.ma = bt.indicators.SMA(self.datas[0].close, period=self.params.ma_period)
        ...
        self.log(
            f"Triple Indicator: MA={self.params.ma_period}, RSI={self.params.rsi_period}"
        )
    ...
    def next(self):
        ...
        if not self.position:
            ...
            high_volume = self.datas[0].volume[0] > (
...
class ScalpingStrategy(BaseAdvancedStrategy):
    ...
    def __init__(self):
        ...
        self.ema_fast = bt.indicators.EMA(
            self.datas[0].close, period=self.params.ema_fast
        )

        self.ema_slow = bt.indicators.EMA(
            self.datas[0].close, period=self.params.ema_slow
        )
        ...
        self.log(
            f"Scalping: EMA {self.params.ema_fast}/{self.params.ema_slow}, Stop: 0.5%"
        )
...
class SwingTradingStrategy(BaseAdvancedStrategy):
    ...
    def __init__(self):
        ...
        self.log(
            f"Swing Trading: MA {self.params.ma_short}/{self.params.ma_long}, ATR Stop"
        )
