...
def run_benchmark():
    ...
    try:
        ...
        time_per_combo = (
            metrics["total_time"] / metrics["combinations_tested"]
            if metrics["combinations_tested"] > 0
            else 0
        )
        ...
        old_time_estimate = (metrics["combinations_tested"] * 3.0) + (
            metrics["combinations_tested"] * 0.6
        )
        improvement = (
            old_time_estimate / metrics["total_time"]
