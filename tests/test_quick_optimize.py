...
try:
    from optimization.optuna_presets import (
        OPTUNA_PRESETS,
        get_optuna_preset,
        list_optuna_presets,
    )
...
try:
    ...
    config["period"] = {"start": "2024-01-01", "end": "2024-02-01"}  # 1 mois seulement
...
try:
    ...
    if plots_dir.exists():
        ...
        if plots:
            ...
            print(
                "   ⚠️  Aucune visualisation trouvée (peut être normal pour si peu de trials)"
            )
    else:
