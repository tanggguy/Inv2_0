...
def test_strategy_adaptation():
    ...
    config_rsi = config_mgr.adapt_preset_for_strategy(
        "standard", "RSIStrategy", opt_type="optuna"
    )
    ...
    config_ma = config_mgr.adapt_preset_for_strategy(
        "standard", "MovingAverageStrategy", opt_type="optuna"
    )
    ...
    assert (
        config_rsi["param_grid"] != config_ma["param_grid"]
...
def test_param_grid_consistency():
    ...
    assert (
        config_grid["param_grid"] == config_optuna["param_grid"]
